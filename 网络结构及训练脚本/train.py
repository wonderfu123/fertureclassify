...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_url', type=str, default='/home/work/dataset',
                        help='the obs url to save data')
    parser.add_argument('--num_gpus', type=int, default=0,
                        help='num of gpus')
    parser.add_argument('--train_url', type=str, default='s3://obs--jnn/save_model/caffe_facer/',
                        help='the obs url to save model')
    parser.add_argument('--data_path_suffix', type=str, default='codes',
    ...
    parser.add_argument('--model_local_path', type=str, default='/home/work/My_Facialnet',
    ...
    try:
        if mox.file.exists(data_url):
            ...
            # Training
            solver_name = 'facialnet_solver.prototxt'
            ...
            inter_save_process = multiprocessing.Process(target=save_inter_model,
                                                         args=(model_local_output, model_obs_output, 1))
