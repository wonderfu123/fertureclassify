...
resnet18OmFileName='./models/feature_classify.om'
srcFileDir = './ImageNetRaw/'
dstFileDir = './feature_classifyResult/'
...
def main():
	...
	for allDir in pathDir :
		...
		inputImageTensor = hiai.NNTensor(input_image,dvppInWidth,dvppInHeight,3,'testImage',DataType.UINT8_T, dvppInWidth*dvppInHeight)
